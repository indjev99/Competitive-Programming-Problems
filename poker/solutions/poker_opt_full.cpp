...
void init()
{
    for (int i = 0; i < n; ++i)
    {
        openBetProbs[i] = randReal(0, 1);
        betCallProbs[i] = randReal(0, 1);
        checkBetProbs[i] = randReal(0, 1);
        checkBetCallProbs[i] = randReal(0, 1);
    }
}
