...
int main()
{
    ...
    if (resIters.first == RES_NONE) std::cout << "No robots fired" << std::endl;
    else if (resIters.first == RES_NOSYNC) std::cout << "Only some robot(s) fired" << std::endl;
    else if (resIters.first == RES_SYNC) std::cout << "All robots fired" << std::endl;
